...
public final class RolloverGeyserForm {
    ...
    public static void openForm(Player player) {
        ...
        SimpleForm form = SimpleForm.builder()
                .title(TaiXiu.nms.addColor(cfg.getString("form.rollover.title", "Rollover")))
                .content(TaiXiu.nms.addColor(cfg.getString("form.rollover.content", "Choose an action")))
                .button(TaiXiu.nms.addColor(cfg.getString("form.rollover.button.tai", "Tai / High")))
                .button(TaiXiu.nms.addColor(cfg.getString("form.rollover.button.xiu", "Xiu / Low")))
                .button(TaiXiu.nms.addColor(cfg.getString("form.rollover.button.cashout", "Cash out")))
